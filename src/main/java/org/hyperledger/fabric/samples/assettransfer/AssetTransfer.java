...
public final class AssetTransfer implements ContractInterface {
    ...
    /**
     * Duplicates the asset on the ledger and assigns a new owner to the duplicate asset.
     *
     * @param ctx the transaction context
     * @param assetID the ID of the asset being transferred
     * @param newAssetID the ID of the new duplicate asset being created
     * @param duplicateAssetOwner the owner of the duplicate asset
     * @return the duplicate asset
     */

    @Transaction(intent = Transaction.TYPE.SUBMIT)
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String newAssetID, final String newAssetOwner){

        // Exception thrown when the newAssetID specified already exists
        ...
        // Throws exception when the asset specified by the assetID does not exist
